...
class getNelmioApiDoc_Describers_ConfigService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['nelmio_api_doc.describers.config'] = new \Nelmio\ApiDocBundle\Describer\ExternalDocDescriber(['info' => ['title' => 'Instagrume API', 'description' => 'Application de gestion de Instagrume', 'version' => '1.0.0'], 'security' => [['jwt' => []]], 'components' => ['securitySchemes' => ['jwt' => ['type' => 'apiKey', 'in' => 'header', 'name' => 'Authorization']]]]);
    }
}
