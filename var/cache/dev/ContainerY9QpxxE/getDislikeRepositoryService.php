 ...
 */
class getDislikeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DislikeRepository' shared autowired service.
     *
     * @return \App\Repository\DislikeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DislikeRepository.php';

        return $container->privates['App\\Repository\\DislikeRepository'] = new \App\Repository\DislikeRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
